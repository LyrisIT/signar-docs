...
Hemos incorporado nuevas características y mejoras gráficas para que la gestión de permisos sea más amigable y fácil de usar. Ahora, en cada recurso se puede ver qué acciones tiene permitido realizar un usuario con permisos en el mismo, también agregamos nuevas funcionalidades respecto a las herencias de permisos y propietarios de documentos.
...
Realizamos modificaciones de UX/UI para que la nueva forma en que se muestran los permisos sea más atractiva, amigable y descriptiva. Ahora, el usuario puede ver qué acciones puede realizar cada sujeto con permisos hacia un documento, carpeta o unidad compuesta. 
